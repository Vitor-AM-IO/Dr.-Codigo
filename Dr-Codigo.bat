...
REM --- Python encontrado: abre o Dr. Codigo ---
"%PYCMD%" start.py
pause
exit /b
...
:SEM_PYTHON
echo ============================================================
echo   O Python nao esta instalado (o Dr. Codigo precisa dele).
echo ============================================================
echo.
...
if %errorlevel%==0 (
  ...
  echo.
  echo ------------------------------------------------------------
  echo   Pronto! Agora FECHE esta janela e abra o Dr-Codigo.bat
  echo   de novo ^(o Windows precisa reconhecer o Python^).
  echo ------------------------------------------------------------
) else (
